...
class DictionaryTest < Minitest::Test
  ...
  VALID_UNITS = ["naps", "naps per weekday", "weekends", "workdays", "bouts", "lux", "naps per day", "minutes per day", "hours per day", "cups", "days", "mmol per mol", "centimeters", "", "packs", "percent", "drinks", "cigarettes",
